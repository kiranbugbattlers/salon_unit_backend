...
async function runMigration() {
  try {
    ...
    const migrationPath = path.join(__dirname, '../src/database/migrations/add-remark-to-business-approvals.sql');
    const sql = fs.readFileSync(migrationPath, 'utf8');

    console.log('\n📝 Running migration: add-remark-to-business-approvals.sql');
    ...
    console.log('\n🎉 Business approvals remark column added!');
