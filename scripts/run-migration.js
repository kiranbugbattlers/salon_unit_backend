...
async function runMigration() {
  try {
    ...
    const migrationPath = path.join(__dirname, '../database/scripts/add-missing-business-owner-columns.sql');
    const sql = fs.readFileSync(migrationPath, 'utf8');

    console.log('\n📝 Running migration: add-missing-business-owner-columns.sql');
