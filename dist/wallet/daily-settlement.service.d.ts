...
import { DailySettlement, SettlementPaidStatus, Booking, BusinessOwner, BusinessAddress } from '../database/entities';
export declare class DailySettlementService {
    ...
    private readonly COMMISSION_PERCENT;
    private readonly GST_PERCENT;
    constructor(dailySettlementRepository: Repository<DailySettlement>, bookingRepository: Repository<Booking>, businessOwnerRepository: Repository<BusinessOwner>, businessAddressRepository: Repository<BusinessAddress>, dataSource: DataSource);
