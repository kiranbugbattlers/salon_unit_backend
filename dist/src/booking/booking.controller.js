...
const customer_add_services_dto_1 = require("./dto/customer-add-services.dto");
const approve_addon_response_dto_1 = require("./dto/approve-addon-response.dto");
const reject_addon_response_dto_1 = require("./dto/reject-addon-response.dto");
...
let BookingController = class BookingController {
    ...
    async previewDeliveryCharge(previewDto) {
        return this.bookingService.previewDeliveryCharge(previewDto.businessOwnerId, previewDto.customerLatitude, previewDto.customerLongitude, previewDto.businessServiceIds, previewDto.servicePackageIds);
    }
    async addServices(user, bookingId, addServicesDto) {
        return this.bookingService.addServicesToBooking(bookingId, user.businessOwnerId || user.customerId, addServicesDto);
    }
    async customerAddServices(user, bookingId, customerAddServicesDto) {
        return this.bookingService.addServicesToBooking(bookingId, null, customerAddServicesDto, user.customerId);
    }
    async getCustomerBookings(customerId, query) {
        return this.bookingService.getCustomerBookings(customerId, query);
    }
    async updateBooking(user, bookingId, updateBookingDto) {
    ...
    async approveAddOnService(user, bookingId, serviceId) {
        return this.bookingService.approveAddOnService(user.customerId, bookingId, serviceId);
    }
    async rejectAddOnService(user, bookingId, serviceId) {
        return this.bookingService.rejectAddOnService(user.customerId, bookingId, serviceId);
    }
    async getCustomerTransactionHistory(user, customerId, startDate, endDate) {
        const targetCustomerId = customerId || user.customerId;
        if (customerId && customerId !== user.customerId && !user.roles.includes(user_role_enum_1.UserRole.ADMIN)) {
            throw new common_1.ForbiddenException('You can only view your own transaction history');
        }
...
__decorate([
    (0, common_1.Post)('preview-delivery-charge'),
    (0, swagger_1.ApiBearerAuth)('JWT'),
    (0, swagger_1.ApiOperation)({
    ...
    (0, swagger_1.ApiBody)({ type: dto_1.PreviewDeliveryChargeDto }),
    (0, swagger_1.ApiResponse)({
        status: 200,
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [dto_1.PreviewDeliveryChargeDto]),
    __metadata("design:returntype", Promise)
], BookingController.prototype, "previewDeliveryCharge", null);
__decorate([
    (0, common_1.Post)(':bookingId/add-services'),
    (0, swagger_1.ApiBearerAuth)('JWT'),
    (0, swagger_1.ApiOperation)({
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String, dto_1.AddServicesDto]),
    __metadata("design:returntype", Promise)
], BookingController.prototype, "addServices", null);
__decorate([
    (0, common_1.Post)(':bookingId/customer-add-services'),
    ...
    (0, swagger_1.ApiBody)({
        type: customer_add_services_dto_1.CustomerAddServicesDto,
    ...
    __param(2, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String, customer_add_services_dto_1.CustomerAddServicesDto]),
    __metadata("design:returntype", Promise)
], BookingController.prototype, "customerAddServices", null);
__decorate([
    ...
    (0, swagger_1.ApiResponse)({
        ...
        type: dto_1.BookingListResponseDto,
    }),
    (0, swagger_1.ApiResponse)({
        status: 404,
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, dto_1.BookingQueryDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    (0, common_1.Patch)(':bookingId/services/:serviceId/approve'),
    (0, roles_decorator_1.Roles)(user_role_enum_1.UserRole.CUSTOMER),
    (0, swagger_1.ApiBearerAuth)('JWT'),
    (0, swagger_1.ApiOperation)({
    ...
    (0, swagger_1.ApiResponse)({
        ...
        type: approve_addon_response_dto_1.ApproveAddonResponseDto,
        schema: {
            example: {
                code: 200,
                success: true,
    ...
    __metadata("design:returntype", Promise)
], BookingController.prototype, "approveAddOnService", null);
__decorate([
    (0, common_1.Delete)(':bookingId/services/:serviceId'),
    (0, roles_decorator_1.Roles)(user_role_enum_1.UserRole.CUSTOMER),
    (0, swagger_1.ApiBearerAuth)('JWT'),
    (0, swagger_1.ApiOperation)({
    ...
    (0, swagger_1.ApiResponse)({
        ...
        type: reject_addon_response_dto_1.RejectAddonResponseDto,
        schema: {
            example: {
                code: 200,
                success: true,
    ...
    __metadata("design:paramtypes", [Object, String, String]),
    __metadata("design:returntype", Promise)
], BookingController.prototype, "rejectAddOnService", null);
__decorate([
    (0, common_1.Get)('customer-transaction-history'),
    (0, swagger_1.ApiBearerAuth)('JWT'),
    (0, swagger_1.ApiOperation)({
    ...
    __metadata("design:returntype", Promise)
], BookingController.prototype, "getCustomerTransactionHistory", null);
